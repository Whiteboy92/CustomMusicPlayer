...
public class AudioService : IAudioService
{
    ...
    private void WaveOut_PlaybackStopped(object? sender, StoppedEventArgs e)
    {
        ...
        // Natural end = the stream ran out on its own. A user Stop() (or loading
        // a new file, which calls Stop) sets stopRequested, so those don't count.
        var endedNaturally = !stopRequested && e.Exception == null;
        stopRequested = false;
