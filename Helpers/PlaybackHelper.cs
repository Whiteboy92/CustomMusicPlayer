...
namespace MusicPlayer.Helpers
{
	public static class PlaybackHelper
	{
		...
		{
			var queuePaths = playlist.Playlist.Select(s => s.FilePath).ToList();
			settings.SaveCurrentQueue(queuePaths, isShuffled);
		}

		public static void RestorePlaybackState(ISettingsService settings, PlaylistView playlist, PlayerControlsView player, Dispatcher dispatcher)
		{
